...
function ShowQuestion() {
    ...
    const answerClass = `my-4 text-xs font-medium me-2 px-2.5 py-1.5 rounded border ${isCorrect ? 'bg-green-100 text-green-800 border-green-400' : 'bg-red-100 text-red-800 border-red-400'
        }`;
        ...
        <section className="bg-white dark:bg-gray-900">
            {
                !isStartTest ? (<>
                    <div className="h-screen bg-dark-400 grid grid-cols-1 gap-4  content-center ">
                        ...
                        className="justify-self-center lg:w-64 w-32 align-center focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Start</button>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="basis-3/4  mx-2 bg-white p-8 rounded-md shadow-md" style={{ border: "1px solid black" }}>
                                ...
                                <button className="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me:0 lg:me-2  mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" onClick={() => { showQuestionAnswer() }} >Answer</button>
                                <button className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me:0 lg:me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={() => { getQuestion() }} >Next</button>

                            </div>

                            <div className="bg-dark basis-1/4 ml-2">
                                <div className="my-4">
                                    <span class=" bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">Subject :{question.subject}</span>
                                </div>
                                <div>
                                    <span class="bg-purple-100 rounded text-purple-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-purple-900 dark:text-purple-300">Topic : {question.topic}</span>
                                </div>
                                <div className="my-4">
